...
#ifndef CPR_PULSE_COACH_SWIFT_H
#define CPR_PULSE_COACH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="cpr_pulse_coach",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC15cpr_pulse_coach11AppDelegate")
...
SWIFT_CLASS("_TtC15cpr_pulse_coach17MainFlutterWindow")
